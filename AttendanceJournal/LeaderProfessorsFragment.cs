...
namespace AttendanceJournal
{
    public class LeaderProfessorsFragment : Android.Support.V4.App.Fragment
    {
        ...
        public override View OnCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
        {
            ...
            professorsList.Add(new Professor { id = 0, room = 510, name = "Преподаватель 1", phone = 380666 });
            professorsList.Add(new Professor { id = 0, room = 310, name = "Преподаватель 2", phone = 380556 });
    ...
    public class ProfessorAdapter : BaseAdapter<Professor>
    {
        ...
        public override View GetView(int position, View convertView, ViewGroup parent)
        {
            ...
            try
            {
                ...
                tvName.Text = professors[position].name;
